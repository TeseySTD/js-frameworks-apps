...
const DEFAULT_ARTICLES: Article[] = [
  new Article({
    ...
    readTime: 8,
    snippet:
      'Exploring key changes in .NET 10 ecosystem: Native AOT, performance boosts, and cloud-native features.',
    author: {
      name: 'Nick Chapsas',
  ...
  new Article({
    ...
    readTime: 7,
    snippet:
      'Optimizing LINQ queries and using the new Compiled Models for massive performance gains.',
  ...
  new Article({
    ...
    readTime: 10,
    snippet:
      'Lessons learned from building a cross-platform book reader using .NET MAUI and Blazor.',
  ...
  new Article({
    ...
    readTime: 6,
    snippet:
      'Why Terminal User Interfaces are gaining popularity and how RazorConsole helps building them.',
    author: { name: 'Rout', avatar: 'https://avatars.githubusercontent.com/u/1?v=4' },
    content: [
  ...
  new Article({
    ...
    readTime: 9,
    snippet:
      'Writing unit tests that actually describe your business requirements, not just coverage.',
  ...
  new Article({
    ...
    readTime: 8,
    snippet:
      'Checking out new pattern matching improvements and the long-awaited Discriminated Unions.',
  ...
  new Article({
    ...
    readTime: 11,
    snippet:
      'Scaling your .NET API to handle millions of requests with intelligent caching strategies.',
    author: {
      name: 'Nick Chapsas',
      avatar: 'https://avatars.githubusercontent.com/u/8199968?v=4',
    },
